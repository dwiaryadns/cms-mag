...
class ApiIndotekController extends Controller
{
    ...
    public $GetGroupPolicyUserList = "https://simulasihealthmobile.mag.co.id/api/v1/other/GetGroupPolicyUseList";
    ...
    public function getGroupPolList()
    {
        $getToken = $this->getToken();
        return $getToken;
    }
    public function GetGroupPolicyUseList() {}
